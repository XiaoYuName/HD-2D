...
namespace UnityTcp.Editor.Native
{
    internal static partial class NativeWindowBridgeHost
    {
        ...
        private static int[] s_CachedObjectSelectorTargetInstanceIds;
        private static int s_CachedObjectBeingEditedId;
        ...
        private static int s_CachedObjectSelectorOriginalSelectionId;
        ...
        private static void RestoreObjectSelectorSessionFields(object selector)
        {
            ...
            if (s_CachedObjectBeingEditedId != 0 && s_ObjectSelectorObjectBeingEditedField != null)
            {
                UnityEngine.Object objectBeingEdited =
                    EditorUtility.InstanceIDToObject(s_CachedObjectBeingEditedId);
            ...
            if (selector != null)
            {
                ...
                if (s_ObjectSelectorObjectBeingEditedField != null)
                {
                    ...
                    s_CachedObjectBeingEditedId =
                        objectBeingEdited != null ? objectBeingEdited.GetInstanceID() : 0;
                }
                ...
                if (s_ObjectSelectorOriginalSelectionField != null)
                {
                    ...
                    s_CachedObjectSelectorOriginalSelectionId =
                        originalSelection != null ? originalSelection.GetInstanceID() : 0;
                }
                ...
                if (s_ObjectSelectorEditedPropertyField != null)
                {
                    ...
                    if (editedProperty != null && !string.IsNullOrEmpty(editedProperty.propertyPath))
                    {
                        ...
                        {
                            s_CachedObjectSelectorTargetInstanceIds = new int[targets.Length];
                            for (int i = 0; i < targets.Length; i++)
                                s_CachedObjectSelectorTargetInstanceIds[i] = targets[i].GetInstanceID();
                        }
                    }
                }
            }
        ...
        private static int[] GetOffscreenInspectorTargetInstanceIds()
        {
            ...
            if (activeObject != null)
                AppendUniqueTargetId(ids, activeObject.GetInstanceID());

            return ids.ToArray();
        }

        private static void AppendEditorTargetInstanceIds(List<int> ids, object tracker)
        {
            if (tracker == null)
                return;
            ...
            foreach (UnityEditor.Editor editor in activeEditors)
            {
                ...
                if (editor.target != null)
                    AppendUniqueTargetId(ids, editor.target.GetInstanceID());
                ...
                {
                    if (target != null)
                        AppendUniqueTargetId(ids, target.GetInstanceID());
                }
            }
        }

        private static void AppendUniqueTargetId(List<int> ids, int instanceId)
        {
        ...
        {
            int[] inspectorIds = GetOffscreenInspectorTargetInstanceIds();
            ...
            {
                var merged = new List<int>(s_CachedObjectSelectorTargetInstanceIds);
                foreach (int id in inspectorIds)
        ...
        private static UnityEngine.Object ResolveObjectSelectorInstance(int instanceId)
        {
            ...
            UnityEngine.Object obj = InternalEditorUtility.GetObjectFromInstanceID(instanceId);
            if (obj != null)
                return obj;
            ...
            bool restrictToOriginalSelection)
        {
            ...
            foreach (string preferredPath in preferredPaths)
            {
                ...
                if (restrictToOriginalSelection &&
                    ...
                    preferredProperty.objectReferenceValue.GetInstanceID() ==
                    s_CachedObjectSelectorOriginalSelectionId)
                {
                ...
                if (iterator.NextVisible(true))
                {
                    do
                    {
                        ...
                        if (restrictToOriginalSelection &&
                            ...
                            iterator.objectReferenceValue.GetInstanceID() ==
                            s_CachedObjectSelectorOriginalSelectionId)
                        {
        ...
        private static IEnumerable<int> OrderTargetIdsForMeshApply(int[] targetIds)
        {
            ...
            {
                UnityEngine.Object obj = InternalEditorUtility.GetObjectFromInstanceID(targetId);
                if (obj == null)
                    obj = EditorUtility.InstanceIDToObject(targetId);
        ...
        private static bool TryApplyObjectSelectorPropertyScan(UnityEngine.Object selectedObject)
        {
            ...
            int[] targetIds = s_CachedObjectSelectorTargetInstanceIds;
            ...
            foreach (int targetId in OrderTargetIdsForMeshApply(targetIds))
            {
                UnityEngine.Object rootTarget = InternalEditorUtility.GetObjectFromInstanceID(targetId);
                if (rootTarget == null)
                    rootTarget = EditorUtility.InstanceIDToObject(targetId);
                if (rootTarget == null)
                    continue;
