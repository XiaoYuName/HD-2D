...
public sealed partial class SexToShopData : Luban.BeanBase
{
    public SexToShopData(JToken _buf) 
    {
    ...
    public static SexToShopData DeserializeSexToShopData(JToken _buf)
    {
        return new SexToShopData(_buf);
    }
    ...
    public const int __ID__ = -1983341503;
