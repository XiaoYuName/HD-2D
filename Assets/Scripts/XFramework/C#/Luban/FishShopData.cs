...
public sealed partial class FishShopData : Luban.BeanBase
{
    public FishShopData(JToken _buf) 
    {
    ...
    public static FishShopData DeserializeFishShopData(JToken _buf)
    {
        return new FishShopData(_buf);
    }
    ...
    public const int __ID__ = 342469208;
