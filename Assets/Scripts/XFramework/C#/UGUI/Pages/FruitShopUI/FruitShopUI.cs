...
public class FruitShopUI : BaseShopUI
{
    /// <summary>
    /// 绑定具体商店的库存变化事件。
    ...
    {
        ShopManager.Instance.RegisterFruitShopChange(callback);
    }
    ...
    {
        ShopManager.Instance.UnregisterFruitShopChange(callback);
    }
    ...
    {
        ShopManager.Instance.SetFruitShops(shopItems);
    }
    ...
    {
        return ShopManager.Instance.GetFruitShopGoodsData(itemID);
    }
}
