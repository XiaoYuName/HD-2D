...
public sealed partial class FruitShopData : Luban.BeanBase
{
    public FruitShopData(JToken _buf) 
    {
    ...
    public static FruitShopData DeserializeFruitShopData(JToken _buf)
    {
        return new FruitShopData(_buf);
    }
    ...
    public const int __ID__ = 30738388;
