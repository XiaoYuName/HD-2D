	...
	public class Components {
		...
		static public void CopyRigidbody2D(Rigidbody2D originalRigidBody, Sliceable2D slicer, Polygon2D id, double originArea) {
			if (originalRigidBody) {
				...
				newRigidBody.bodyType = originalRigidBody.bodyType;
				newRigidBody.linearVelocity = originalRigidBody.linearVelocity;
				newRigidBody.linearDamping = originalRigidBody.linearDamping;
				newRigidBody.angularVelocity = originalRigidBody.angularVelocity;
				newRigidBody.angularDamping = originalRigidBody.angularDamping;
