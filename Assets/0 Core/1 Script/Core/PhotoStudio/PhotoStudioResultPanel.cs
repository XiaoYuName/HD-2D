...
public sealed class PhotoStudioResultPanel : MonoBehaviour
{
    ...
    void CreateResultPanelUI()
    {
        ...
        LocalizeTool.BindText(titleText, LocalizeTableSet.PhotoStudio, "SettleTitle", "本局结算");
        ...
        LocalizeTool.BindText(itemLabel, LocalizeTableSet.PhotoStudio, "SettleIntoBag", "已放入背包");
        ...
        LocalizeTool.BindText(autoTip, LocalizeTableSet.PhotoStudio, "SettleAutoToBag", "道具已自动发放进背包");
        ...
        LocalizeTool.BindText(replayLabel, LocalizeTableSet.PhotoStudio, "SettleReplay", "再来一局");
        ...
        LocalizeTool.BindText(costText, LocalizeTableSet.PhotoStudio, "SettleReplayCost", "消耗行动值-1");
        ...
        LocalizeTool.BindText(returnLabel, LocalizeTableSet.PhotoStudio, "SettleReturn", "返回");
    ...
    TextMeshProUGUI CreateStatRow(RectTransform parent, float y, string labelZh, string labelKey, string defaultZh, Color valueColor, string defaultValue)
    {
        ...
        LocalizeTool.BindText(label, LocalizeTableSet.PhotoStudio, labelKey, defaultZh);
